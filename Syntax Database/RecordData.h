...
namespace Syntax
{
	...
	{
		class RecordData :
			public Syntax::Database::IRecordData
		{
		public:
			RecordData(Syntax::Utility::BinaryReader *reader);
			virtual ~RecordData();
			...
			virtual IRecordData& operator>>(Syntax::Utility::ISerializable &data) {return PassThrough(data);}
			//! Reads a ISerializable out to the file.
			virtual IRecordData& operator>>(Syntax::Utility::ISerializable *data) {return PassThrough(data);}
			//! Reads a Vector4F out to the file.
			virtual IRecordData& operator>>(Syntax::Math::Vector4F &data) {return PassThrough(data);}
			//! Reads a Guid out to the file.
			virtual IRecordData& operator>>(Syntax::Utility::Guid &data) {return PassThrough(data);}
			//! Reads a RectangleI out to the file.
			virtual IRecordData& operator>>(Syntax::Math::RectangleI &data) {return PassThrough(data);}
			//! Reads a Color32 out to the file.
			virtual IRecordData& operator>>(Syntax::Math::Color32 &data) {return PassThrough(data);}
