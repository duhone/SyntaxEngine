#pragma once
#include "..\syntaxcompilerlib\icompiler.h"
#include<vector>
#include <hash_map>
#include <hash_set>
...
namespace Syntax
{
	namespace Compiler
	{
		...
		class CompilerImpl :
			public ICompiler, public Syntax::Utility::Singleton<CompilerImpl>
		{
		...
		public:
			...
			void SetTop(Syntax::Compiler::INodeCompiler *top);
		...
		private:
			...
			Syntax::Compiler::TopCompiler *top;
			Asset *topAsset;
			void CopyFiles(void);
